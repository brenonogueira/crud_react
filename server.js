...
var model = mongoose.model('pessoa', CadastroSchema, 'pessoa');  
 ...
 model.remove({ _id: req.body.id }, function(err) {  
            if(err){  
                res.send(err);  
                   ...
                   res.send({data:"Cadastro deletado com sucesso!"});             
               }  
        });  
})  
...
function(err) {  
 ...
 res.send({data:"Cadastro atualizado com sucesso!"});  
 });  
})    
        ...
        mod.save(function(err,data){  
            if(err){  
                res.send(err);                
                 ...
                 res.send({data:"Cadastro inserido com sucesso!"});  
            }  
        });  
})  
